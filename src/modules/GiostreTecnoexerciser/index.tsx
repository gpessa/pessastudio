...
const GiostreTecnoexerciser: React.FC = () => (
  <>
        ...
        <>
          ...
          <Trans>
            <Typography paragraph>
              Tecnoexerciser è il modello di giostra attualmente più richiesto.
            </Typography>
            <Typography paragraph>
              Oggi, grazie alle già note caratteristiche tecniche e alla grande
              affidabilità, abbiamo aggiunto alcune specifiche funzioni che
              fanno, di questo modello, la macchina <strong>leader</strong> del
              settore.
            </Typography>
            ...
            <Typography paragraph>
              La struttura è fornita, a seconda delle esigenze, o con punte per
              l'ancoraggio al suolo o con tasselli nel caso in cui si desideri
              ancorarla ad un fondo di calcestruzzo.
            </Typography>
          </Trans>
        </>
      }
    ...
    <Video
      ...
      title={t`Giostra TECNOEXERCISER in movimento`}
    />
