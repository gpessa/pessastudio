...
export const GIOSTRA_DESCRIZIONE_RECINZIONE_TECONOFENCE = (
  <Trans>
    ...
    <Typography textAlign="justify">
      L'innovativo materiale utilizzato per la sua costruzione (PPO) è durevole nel tempo e ti consentirà di abbattere i
      costi di manutenzione che affliggono le classiche recinzioni in legno.
    </Typography>
