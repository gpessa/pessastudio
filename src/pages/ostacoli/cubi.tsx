...
const Cubi = () => (
  <Section>
    <Row>
      ...
      <Col md={3} as={Product} colors={[Colors.WHITE, Colors.BLU, Colors.YELLOW, Colors.RED, Colors.GREEN]} height={57} image={require("../../images/product/ostacoli/cubi-mini.jpg")} length={37} name="Cubi Mini" price={35} weight={3} width={35} />
      <Col md={3} as={Product} colors={[Colors.WHITE, Colors.BLU, Colors.YELLOW, Colors.RED, Colors.GREEN]} height={70} image={require("../../images/product/ostacoli/cubi-maxi.jpg")} length={57} name="Cubi Maxi" price={62} weight={5} width={37} />
    </Row>
  </Section>
)
