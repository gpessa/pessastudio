...
const RecintiFondi = ({ intl: { formatMessage } }) => {
  const IMAGES = [
    {
      caption: formatMessage({ id: `RECINTI_E_FONDI_image_1` }),
      src: require("../images/product/recinti/recinti-image-1.jpg"),
    },
    {
      caption: formatMessage({ id: `RECINTI_E_FONDI_image_2` }),
      src: require("../images/product/recinti/recinti-image-2.jpg"),
    },
    {
      caption: formatMessage({ id: `RECINTI_E_FONDI_image_3` }),
      src: require("../images/product/recinti/recinti-image-3.jpg"),
    },
    {
      caption: formatMessage({ id: `RECINTI_E_FONDI_image_4` }),
  ...
  return (
    <>
      <Columns
        ...
        left={
          <>
            ...
            <p>
              Le recinzioni <strong>Tecno Fence</strong> sono realizzate con materiale particolarmente adatto a durare
            ...
            <p>
              ...
              altri prodotti utilizzati per il medesimo scopo, gli animali non mordono la recinzione. Tecno Fence, non
              presenta spigoli vivi e inoltre, essendo elastica, è in grado di assorbire gli urti senza rompersi
              evitando cosi di provocare infortuni a persone e animali.{" "}
            </p>
            <p>
              Il materiale impiegato è lo stesso che viene utilizzato per la produzione di serramenti dove
              l’inalterabilità del colore e delle caratteristiche tecniche sono condizioni indispensabili per garantire
              un prodotto di qualità. L’inclusione di inibitori dei raggi ultravioletti consente anche di prevenire
              crepe e rotture e di resistere alla corrosione e allo sfogliamento mantenendo, inalterate, le
            ...
            <p>
              ...
              Variabili le altezze che vanno da 1,20 mt a 1,90 mt, misura quest’ultima utilizzata principalmente per
            ...
            <p>
              Tutte le nostre recinzioni sono personalizzate in base alle esigenze di metratura e di figura del cliente.
            </p>
          </>
        }
      ...
      <Section>
        ...
        <ul>
          <li>
            Preparare la superficie spianandola a " SCHIENA D'ASINO " con il centro più alto dei bordi (2%) per far si
            che la pioggia defluisca. Mantenere i bordi dell'area alla stessa altezza del terreno circostante e
            riportare materiale nel centro dell'area per alzarlo.
          </li>
          <li>
            Stendere sull'area una "RETE DI SEPARAZIONE", ben tesa e trattenuta lungo i bordi in una canaletta scavata
            nel terreno impedendo così che la terra si mescoli alla sabbia.
          </li>
          ...
          <li>
            Tutti i giorni passare con una " ERPICE LIVELLATRICE " per eliminare le impronte lasciate dagli zoccoli.
          </li>
        </ul>
      </Section>
    </>
