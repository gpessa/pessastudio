    ...
    left={
      <>
        ...
        <section className="mb-5">
          ...
          <Address name="PESSASTUDIO Horse Tecnology srl" country="Italy" postalCode="35043" streetAddress="via Garibaldi, 28" addressLocality="Monselice" addressRegion="Padova" />
          <div className="mt-2">
