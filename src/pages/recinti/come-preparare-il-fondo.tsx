...
const ComePreparareIlFondo: React.FC = () => (
  <Section>
    <TH variant="h2">Come preparare il fondo</TH>
    <Ul>
      <li>
        Preparare la superficie spianandola a "schiena d'asino" con il centro più alto dei bordi (2%) per far si che la
        pioggia defluisca. Mantenere i bordi dell'area alla stessa altezza del terreno circostante e riportare materiale
        nel centro dell'area per alzarlo.
      </li>
      <li>
      ...
      <li>
        ...
        mantenere il fondo stabile e morbido. Distribuire successivamente dopo un paio di ingressi a cavallo altri 2 kg.
      </li>
