  ...
  <>
    ...
    <Section className={"text-center bg-light"} fluid>
      <Container>
        ...
        <p>
          L'<strong>innovazione tecnologica</strong> e la{" "}
          <strong>qualità</strong> dei prodotti proposti, aggiunti alla loro{" "}
        ...
        <p>
          Le nostre giostre <strong>TECNOEXERCISER</strong>, in produzione da
          oltre 20 anni, i tondini coperti TECNOHALLE, le recinzioni TECNOFENCE,
          i tapis roulant per cavalli TECNOTAPIS e gli ostacoli in alluminio
          indistruttibili nel tempo, hanno portato la nostra azienda ad essere
          leader nel settore.
        </p>
        <p>
          Negli ultimi anni abbiamo arricchito la nostra gamma con una nicchia
          di prodotti semplici ed economicamente sempre più accessibili, ma
          siamo costantemente alla ricerca di soluzioni innovative per
